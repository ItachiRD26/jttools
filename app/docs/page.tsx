  ...
  search: [
    {
      ...
      example: `curl "https://jeterdev.tools/v1/search/listings?query=ceramic+mug&limit=10" \\
  -H "x-api-key: jt_YOUR_KEY"`,
      response: `{\n  "count": 10,\n  "results": [\n    {\n      "listing_id": 1234567890,\n      "title": "Handmade Ceramic Mug",\n      "price": { "amount": 2500, "divisor": 100, "currency_code": "USD" }\n    }\n  ]\n}`,
    },
  ],
  listings: [
    { method:"GET",    path:"/listings/search",    description:"Search active listings",              params:[{name:"query",type:"string",required:true,description:"Keywords"},{name:"limit",type:"integer",required:false,description:"Max 100"},{name:"offset",type:"integer",required:false,description:"Pagination"}], example:`curl "https://jeterdev.tools/v1/listings/search?query=art" \\\n  -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET",    path:"/listings/get",        description:"Get a listing by ID",                 params:[{name:"listing_id",type:"string",required:true,description:"Etsy listing ID"}], example:`curl "https://jeterdev.tools/v1/listings/get?listing_id=1234567890" \\\n  -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET",    path:"/listings/active",     description:"Get active listings from a shop",     params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"},{name:"limit",type:"integer",required:false,description:""},{name:"offset",type:"integer",required:false,description:""}], example:`curl "https://jeterdev.tools/v1/listings/active?limit=25" \\\n  -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET",    path:"/listings/featured",   description:"Get featured listings",               params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"}], example:`curl "https://jeterdev.tools/v1/listings/featured" \\\n  -H "x-api-key: jt_YOUR_KEY"` },
    { method:"POST",   path:"/listings/create",     description:"Create a new listing",   plan:"Pro+", params:[{name:"body",type:"object",required:true,description:"Listing object per Etsy schema"}], example:`curl -X POST "https://jeterdev.tools/v1/listings/create" \\\n  -H "x-api-key: jt_YOUR_KEY" \\\n  -H "Content-Type: application/json" \\\n  -d '{"title":"My Listing","price":{"amount":2500},...}'` },
    { method:"PATCH",  path:"/listings/update",     description:"Update a listing",       plan:"Pro+", params:[{name:"listing_id",type:"string",required:true,description:"Etsy listing ID"},{name:"body",type:"object",required:true,description:"Fields to update"}], example:`curl -X PATCH "https://jeterdev.tools/v1/listings/update?listing_id=123" \\\n  -H "x-api-key: jt_YOUR_KEY" \\\n  -d '{"title":"New Title"}'` },
    { method:"DELETE", path:"/listings/delete",     description:"Delete a listing",       plan:"Pro+", params:[{name:"listing_id",type:"string",required:true,description:"Etsy listing ID"}], example:`curl -X DELETE "https://jeterdev.tools/v1/listings/delete?listing_id=123" \\\n  -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET",    path:"/listings/images",     description:"Get images for a listing",            params:[{name:"listing_id",type:"string",required:true,description:""}], example:`curl "https://jeterdev.tools/v1/listings/images?listing_id=123" \\\n  -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET",    path:"/listings/inventory",  description:"Get inventory for a listing",         params:[{name:"listing_id",type:"string",required:true,description:""}], example:`curl "https://jeterdev.tools/v1/listings/inventory?listing_id=123" \\\n  -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET",    path:"/listings/properties", description:"Get listing properties/variations",   params:[{name:"listing_id",type:"string",required:true,description:""},{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"}], example:`curl "https://jeterdev.tools/v1/listings/properties?listing_id=123" \\\n  -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET",    path:"/listings/shipping",   description:"Get shipping info for a listing",     params:[{name:"listing_id",type:"string",required:true,description:""}], example:`curl "https://jeterdev.tools/v1/listings/shipping?listing_id=123" \\\n  -H "x-api-key: jt_YOUR_KEY"` },
  ],
  shops: [
    { method:"GET", path:"/shops/get",                 description:"Get shop information",         params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"}], example:`curl "https://jeterdev.tools/v1/shops/get?shop_id=YOUR_SHOP_ID" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET", path:"/shops/listings",            description:"Get all listings from a shop", params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"},{name:"limit",type:"integer",required:false,description:""},{name:"offset",type:"integer",required:false,description:""}], example:`curl "https://jeterdev.tools/v1/shops/listings?shop_id=YOUR_SHOP_ID&limit=50" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET", path:"/shops/sections",            description:"Get shop sections",            params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"}], example:`curl "https://jeterdev.tools/v1/shops/sections?shop_id=YOUR_SHOP_ID" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET", path:"/shops/reviews",             description:"Get shop reviews",             params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"},{name:"limit",type:"integer",required:false,description:""}], example:`curl "https://jeterdev.tools/v1/shops/reviews?shop_id=YOUR_SHOP_ID" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET", path:"/shops/transactions",        description:"Get shop transactions",        params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"}], example:`curl "https://jeterdev.tools/v1/shops/transactions?shop_id=YOUR_SHOP_ID" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET", path:"/shops/orders",              description:"Get shop orders (receipts)",   params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"},{name:"limit",type:"integer",required:false,description:""}], example:`curl "https://jeterdev.tools/v1/shops/orders?shop_id=YOUR_SHOP_ID" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"PUT", path:"/shops/update",              description:"Update shop information", plan:"Pro+", params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"},{name:"body",type:"object",required:true,description:""}], example:`curl -X PUT "https://jeterdev.tools/v1/shops/update" \\\n  -H "x-api-key: jt_YOUR_KEY" -d '{"title":"My Shop"}'` },
    { method:"GET", path:"/shops/production-partners", description:"Get production partners",     params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"}], example:`curl "https://jeterdev.tools/v1/shops/production-partners?shop_id=YOUR_SHOP_ID" -H "x-api-key: jt_YOUR_KEY"` },
  ],
  shipping: [
    { method:"GET",    path:"/shipping/profiles",     description:"List all shipping profiles",          params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"}], example:`curl "https://jeterdev.tools/v1/shipping/profiles?shop_id=YOUR_SHOP_ID" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET",    path:"/shipping/profile",      description:"Get a shipping profile by ID",        params:[{name:"profile_id",type:"string",required:true,description:""},{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"}], example:`curl "https://jeterdev.tools/v1/shipping/profile?profile_id=123" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"POST",   path:"/shipping/create",       description:"Create a shipping profile", plan:"Pro+", params:[{name:"body",type:"object",required:true,description:"Profile object"}], example:`curl -X POST "https://jeterdev.tools/v1/shipping/create" \\\n  -H "x-api-key: jt_YOUR_KEY" -d '{"title":"US Standard"}'` },
    { method:"PUT",    path:"/shipping/update",       description:"Update a shipping profile", plan:"Pro+", params:[{name:"profile_id",type:"string",required:true,description:""}], example:`curl -X PUT "https://jeterdev.tools/v1/shipping/update?profile_id=123" \\\n  -H "x-api-key: jt_YOUR_KEY" -d '{"title":"Updated"}'` },
    { method:"DELETE", path:"/shipping/delete",       description:"Delete a shipping profile", plan:"Pro+", params:[{name:"profile_id",type:"string",required:true,description:""}], example:`curl -X DELETE "https://jeterdev.tools/v1/shipping/delete?profile_id=123" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET",    path:"/shipping/destinations", description:"Get destinations for a profile",      params:[{name:"profile_id",type:"string",required:true,description:""}], example:`curl "https://jeterdev.tools/v1/shipping/destinations?profile_id=123" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET",    path:"/shipping/upgrades",     description:"Get upgrades for a profile",          params:[{name:"profile_id",type:"string",required:true,description:""}], example:`curl "https://jeterdev.tools/v1/shipping/upgrades?profile_id=123" -H "x-api-key: jt_YOUR_KEY"` },
  ],
  categories: [
    { method:"GET", path:"/categories/list",       description:"List the full taxonomy tree",     params:[], example:`curl "https://jeterdev.tools/v1/categories/list" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET", path:"/categories/get",        description:"Get a category by taxonomy ID",   params:[{name:"taxonomy_id",type:"string",required:true,description:"Etsy taxonomy node ID"}], example:`curl "https://jeterdev.tools/v1/categories/get?taxonomy_id=1" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET", path:"/categories/properties", description:"Get properties for a category",   params:[{name:"taxonomy_id",type:"string",required:true,description:""}], example:`curl "https://jeterdev.tools/v1/categories/properties?taxonomy_id=1" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET", path:"/categories/children",   description:"Get child nodes of a category",   params:[{name:"taxonomy_id",type:"string",required:true,description:""}], example:`curl "https://jeterdev.tools/v1/categories/children?taxonomy_id=1" -H "x-api-key: jt_YOUR_KEY"` },
  ],
  images: [
    { method:"GET",    path:"/images/listing", description:"Get all images for a listing",            params:[{name:"listing_id",type:"string",required:true,description:""}], example:`curl "https://jeterdev.tools/v1/images/listing?listing_id=123" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"POST",   path:"/images/upload",  description:"Upload an image to a listing", plan:"Pro+", params:[{name:"listing_id",type:"string",required:true,description:""},{name:"body",type:"multipart",required:true,description:"Image file"}], example:`curl -X POST "https://jeterdev.tools/v1/images/upload?listing_id=123" \\\n  -H "x-api-key: jt_YOUR_KEY" \\\n  -F "image=@photo.jpg"` },
    { method:"DELETE", path:"/images/delete",  description:"Delete an image from a listing", plan:"Pro+", params:[{name:"listing_id",type:"string",required:true,description:""},{name:"listing_image_id",type:"string",required:true,description:""}], example:`curl -X DELETE "https://jeterdev.tools/v1/images/delete?listing_id=123&listing_image_id=456" \\\n  -H "x-api-key: jt_YOUR_KEY"` },
  ],
  users: [
    { method:"GET", path:"/users/me",        description:"Get the authenticated user", params:[], example:`curl "https://jeterdev.tools/v1/users/me" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET", path:"/users/get",       description:"Get a user by ID",           params:[{name:"user_id",type:"string",required:true,description:"Etsy user ID"}], example:`curl "https://jeterdev.tools/v1/users/get?user_id=123" -H "x-api-key: jt_YOUR_KEY"` },
    { method:"GET", path:"/users/addresses", description:"Get addresses for a user",   params:[{name:"user_id",type:"string",required:true,description:""}], example:`curl "https://jeterdev.tools/v1/users/addresses?user_id=123" -H "x-api-key: jt_YOUR_KEY"` },
  ],
  policies: [
    { method:"GET", path:"/policies/get", description:"Get policies for a shop", params:[{name:"shop_id",type:"string",required:true,description:"Your Etsy shop ID (numeric)"}], example:`curl "https://jeterdev.tools/v1/policies/get?shop_id=YOUR_SHOP_ID" -H "x-api-key: jt_YOUR_KEY"` },
  ],
};
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white/3 border border-white/6 rounded-xl p-4">
        ...
        <code className="font-mono text-sm text-[#7F77DD]">https://jeterdev.tools/v1</code>
      </div>
      ...
      <div>
        ...
        <CodeBlock code={`curl "https://jeterdev.tools/v1/listings/search?query=handmade+art&limit=10" \\\n  -H "x-api-key: jt_YOUR_KEY_HERE"`} />
      </div>
    </div>
  );
}
...
function Authentication() {
  return (
    <div className="space-y-5">
      ...
      <CodeBlock code={`curl https://jeterdev.tools/v1/listings/search?query=art \\\n  -H "x-api-key: jt_a3f4b5c6d7e8f9..."`} />
      <div>
